            ...
            <main className="h-full grow overflow-clip portrait:p-2 p-2 md:p-4 lg:p-8 text-neutral-400">
                <div className="relative p-2 w-full h-full glass flex flex-col items-start justify-between">
                    ...
                    <a
                        ...
                        className="text-base lg:text-lg xl:text-2xl drop-shadow-xs hover:text-neutral-300"
                    >
                        Licensed under MIT license
                    </a>
                    <a className="absolute right-2 bottom-2" href="https://arajtav.com">
                        <img
                            className="w-[88px] h-[31px] flex items-end justify-end hover:brightness-125"
